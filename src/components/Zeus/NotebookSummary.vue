<template>
  <div class="w-1/3 bg-slate-700 flex-col h-full p-8 rounded-md">
    ...
    <div class="flex flex-row-reverse mt-4 border-t border-slate-900">
      ...
      >
        <div class="flex flex-row items-center">
          ...
          <span class="tracking-widest"> Pause Service </span>
        </div>
      </button>
    </div>
  </div>
...
export default {
  components: { StatusOnlineIcon, DuplicateIcon, StopIcon, LineSummary },
